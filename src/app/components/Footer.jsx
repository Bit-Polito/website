...
export default function Footer() {
    ...
    return (
        <div className="flex flex-col gap-y-7 mt-[80px] mb-[80px]">
            <div className="flex justify-center mb-[80px]">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 11724 3127"
                    fill="currentColor"
                    className="icon-style !w-[305px] !h-[84.42px]"
                >
            ...
            <div className="flex flex-wrap justify-center gap-[14px] mb-[50px]">
                <a href='mailto: info@bitpolito.it' target="_blank" rel="noopener noreferrer" className="btn-b w-[232.06px] h-[83px]">
                    <img src="icons/bitpolito-icon-mail.svg" className="icon-style"></img>
                    info@bitpolito.it
                </a>
                <a href="https://forms.gle/P9mzEhqh8DdrkyQ96" target="_blank" rel="noopener noreferrer" className="btn-b w-[340.06px] h-[83px]">
                    <img src="icons/bitpolito-icon-share.svg" className="icon-style"></img>
                    {t("apply")}
                </a>
            </div>

            <div className="flex flex-wrap justify-center gap-[14px] mb-[42px]">
                <a href="https://t.me/BitPolitoForum" target="_blank" rel="noopener noreferrer" className="btn-b w-[138px] h-[46px]">
                    <img src="icons/bitpolito-icon-social-telegram.svg" className="icon-style"></img>
                    Telegram
                </a>
                <a href="https://www.linkedin.com/company/bitpolito/?originalSubdomain=it" target="_blank" rel="noopener noreferrer" className="btn-b w-[119px] h-[46px]">
                    <img src="icons/bitpolito-icon-social-linkedin.svg" className="icon-style"></img>
                    LinkedIn
                </a>
                <a href="https://www.x.com/bitpolito" target="_blank" rel="noopener noreferrer" className="btn-b w-[144px] h-[46px]">
                    <img src="icons/bitpolito-icon-social-x.svg" className="icon-style"></img>
                    X (Twitter)
                </a>
                <a href="https://www.instagram.com/bitpolito/" target="_blank" rel="noopener noreferrer" className="btn-b w-[133px] h-[46px]">
                    <img src="icons/bitpolito-icon-social-instagram.svg" className="icon-style"></img>
                    Instagram
                </a>
                <a href="https://www.youtube.com/@BitPolito" target="_blank" rel="noopener noreferrer" className="btn-b w-[123px] h-[46px]">
                    <img src="icons/bitpolito-icon-social-youtube.svg" className="icon-style"></img>
                    YouTube
                </a>
                <a href="https://open.spotify.com/show/3xXqSrkyLloGhTozWMnuhH" target="_blank" rel="noopener noreferrer" className="btn-b w-[123px] h-[46px]">
                    <img src="icons/bitpolito-icon-spotify.svg" className="icon-style"></img>
                    Spotify
                </a>
                <a href="https://github.com/BitPolito" target="_blank" rel="noopener noreferrer" className="btn-b w-[132px] h-[46px]">
